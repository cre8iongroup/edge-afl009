...
export default function DashboardPage() {
  ...
  // Gate only the new-submission CTA — existing sessions always stay visible.
  const blockNewSubmissions = portalClosed && !isAdmin;
                ...
                <CardContent className="flex flex-col items-center justify-center gap-4 p-8 md:p-12 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="max-w-prose text-sm text-muted-foreground">
                      The July&nbsp;8 deadline has passed and the portal is no longer accepting new
                      submissions. If you need immediate assistance, please contact our team at{' '}
                      <a
