  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-1">
          <Link
            href={from === 'review' ? '/review' : from === 'all-sessions' ? '/all-sessions' : from === 'av-orders' ? '/av-orders' : from === 'scenic-orders' ? '/scenic-orders' : from === 'ai-notes-status' ? '/ai-notes-status' : '/dashboard'}
            className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground"
          >
            <ArrowLeft className="h-3.5 w-3.5" />
            {from === 'review' ? 'Back to Review Sessions' : from === 'all-sessions' ? 'Back to All Sessions' : from === 'av-orders' ? 'Back to AV Orders' : from === 'scenic-orders' ? 'Back to Scenic Orders' : from === 'ai-notes-status' ? 'Back to AI Notes Status' : 'Back to Dashboard'}
          </Link>
