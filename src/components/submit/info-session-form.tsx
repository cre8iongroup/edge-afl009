...
export default function InfoSessionForm({ submission }: InfoSessionFormProps) {
    ...
    const [expectedAttendance, setExpectedAttendance] = useState<number>(
        submission?.expectedAttendance ?? 80
    );
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className="space-y-8 rounded-lg border p-6 bg-muted/30">
                                {/* Session Setup — static copy + capacity slider */}
                                <div className="space-y-4">
                                    <div className="space-y-1">
                                        <h3 className="text-lg font-semibold font-headline">Session Format</h3>
                                        <p className="text-sm text-muted-foreground">
                                            Info sessions are held in a presentation-style format.
                                        </p>
                                    </div>
